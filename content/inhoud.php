		...
		$str = "<section>
  		...
  		$str .= "<section>
			...
			$str .= "<fieldset>
					  ...
					  <div>
						<label for='username'>gebruikersnaam<abbr class='verplicht' title='verplicht'>*</abbr>:
							<!-- Start dialogbutton -->
								<br>
								<a href='#' id='dialog_link_username'>Meer uitleg</a>
							<!-- End dialogbutton -->
						</label>
			...
			$str .= "<fieldset>
				  ...
				  <!-- Start foutbox -->
				  <div id='fouten' class='foutBox'>
						<a href='#fouten'>Sommige ingevulde gegevens zijn foutief</a>
				  </div>
				  <!-- End foutbox -->
	...
	//Verzorging pagina
		$str = "<section>
  		...
  		$str .= "<section>
				<p>
					<label>
						<input type='checkbox' id='toonWaterplanten' />Info inclusief waterplanten
					</label>
				</p>


				<p>
					Soms is goede verzorging onvoldoenden: een aantal ziektes belagen onze tuinplanten.
